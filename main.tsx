...
function createShapeArray(x: number, y: number,count:number, shapeFunction): React.ReactElement[] {
  ...
  for (let i = 0; i < count; i++) {
    svgElement=
      new HTMLElements(
        ...
        [innershadowdefs.toJSX(), shapeFunction(x, y)]
      ).toJSX();
...
root.render(
  createElement(
    ...
    {
      className: "page",
    },Title("The Chronis Page", '"Jersey 25", sans-serif'),
    Footer("Dimitri Chronis","Aspiring Retard","https://www.instagram.com/worldly_motors/","https://www.linkedin.com/in/demetrios-chronis-a95212293/"),
      createElement(
        "div",
        { className: "image-col" },
